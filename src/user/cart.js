...
const updateCart = (product, input) =>{
   ...
   .then(info=>{
    ...
    swal(product.name, "Quantity Updated to "+product.qty);
    //for empty the cart
            ...
            <div className="col-lg-9">
                ...
                <table className="table table-bordered mt-5">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colSpan="7" className="text-end bg-info text-iwhite">
                               <b> Total Cost Rs. {total} - Total Cost, {allproduct.length} Items in Cart</b>
                            </td>
                        </tr>
                    </tbody>
                </table>
